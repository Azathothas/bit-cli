# TODO/INDEX.md, the parts that stopped being current

Moved out of `TODO/INDEX.md` on 2026-08-24, when it was rewritten to be a
sorted table, the definitions, the counts and one ordering argument. Everything
here was true when it was written and describes a state the repository has
moved past.

Nothing here binds. What still bound was moved into `TODO/RULES.md`, into the
entry that owns it, or into `TODO/reference-map.md` before the cut, and the
2026-08-24 `PROGRESS.md` names each move.

---

## The triage the first hundred entries came from
...
[T-122](../../TODO/reference-map.md) closed.
...
the aria2 parity checklist is in [phase-c.md](../../TODO/phase-c.md), and the rules that
govern how this repository is worked on are in [RULES.md](../../TODO/RULES.md).

[PROGRESS.md](../../TODO/PROGRESS.md) is the session state: what the last session did and
...
## What the counts prose said, and how the list grew
...
**A fourth was added on 2026-08-22 the same way.** [T-188](../../TODO/disk-io.md) came out
of [T-185](../../TODO/cli-surface.md)'s third acceptance run, and it corrects
[T-013](../../TODO/disk-io.md)'s closing claim: an unselected file lands as a zero byte
...
most common way this list grows. [T-185](../../TODO/cli-surface.md) and
[T-186](../../TODO/cli-surface.md) both came out of [T-184](../../TODO/disk-io.md)'s acceptance and
[T-187](../../TODO/metainfo.md) out of [T-172](../../TODO/metainfo.md)'s. None of the three needed
the corpus and none was findable by reading: each was a run whose output was
not what the entry said it would be.

[T-185](../../TODO/cli-surface.md) is the one that matters. `--exclude-file` on its own
selects nothing and downloads everything, which is the third flag-does-nothing
defect after [T-181](../../TODO/cli-surface.md) and [T-183](../../TODO/cli-surface.md) and a fourth
...
them**, [T-184](../../TODO/disk-io.md) and [T-172](../../TODO/metainfo.md), and both had been written
...
now has its own line in [RULES.md](../../TODO/RULES.md).

**Two entries were closed because another one needed them.**
[T-005](../../TODO/webseed.md) added two fields to a report, which made the schema check
fail, and following the documented way to regenerate `docs/schema.md` deleted
two rows it should have kept. That is [T-158](../../TODO/cli-surface.md), and shipping
...
one, which is the usual way this list grows. [T-184](../../TODO/disk-io.md) came out of
[T-177](../../TODO/disk-io.md)'s fixture, and it is now closed with the premise it was
...
moved it. [T-167](../../TODO/bep-coverage.md), BEP 54 `lt_donthave`, was twenty lines to
...
**One was added by building another.** [T-183](../../TODO/cli-surface.md) is
...
[T-181](../../TODO/cli-surface.md), and neither the audit that found T-181's four flags
...
twentieth, [T-182](../../TODO/cli-surface.md), is done, and it is the one piece of code
...
corpus and were still not found: [T-171](../../TODO/metainfo.md), where `url_list`
accepts a bencoded string or a list and `http_seeds` four lines below it
accepts a list only; and [T-181](../../TODO/cli-surface.md), four flags that parse and are
...
[T-176](../../TODO/create-seed.md) exists because intermodal proposed a lint for torrents
...
[T-017](../../TODO/disk-io.md) and [T-021](../../TODO/peers.md) established. Where a title is now
known false the row above says so, so a reader skimming the table is not
misled by a heading nobody may rename. [T-033](../../TODO/performance.md) said three aria2 flags
"parse and do nothing"; they do not exist and exit 2.
[T-118](../../TODO/cli-surface.md) said neither `docs/flags.md` nor its CI check exists;
both do, and four tests enforce them. [T-161](../../TODO/cli-surface.md) named two CI call
...
[multi-source.md](../../TODO/multi-source.md) records which of the five scenarios work,
...
which closes [T-182](../../TODO/cli-surface.md). That tree carries the whole doc
...
annotation is [T-161](../../TODO/cli-surface.md), a build action still targeting
Node.js 20.

**Run 32461172199 was green on all sixteen jobs**, against the commit that
closes [T-162](../../TODO/webseed.md). That tree carries `bench swarm`, the T-040 answer, the
deleted reference trees, and the fixes for both tests that turned a job red this
session. Its only annotation is [T-161](../../TODO/cli-surface.md), a build action still
...
32478382564, `Test (macos-latest)`. That is [T-182](../../TODO/cli-surface.md), fixed: a
...
Four now, counting [T-148](../../TODO/bench.md), which was found locally.

**Two earlier pushes turned a job red, and both were
documentation-only commits.** [T-160](../../TODO/cli-surface.md) on `ubuntu-latest` and
[T-162](../../TODO/webseed.md) on `macos-latest`. Neither was a defect in `bit-cli`: one
...
That is [T-160](../../TODO/cli-surface.md), fixed, and it had already failed once locally
...
## The note on `blocked`, which was empty when it was written
...
[T-016](../../TODO/disk-io.md) was blocked on a resume cache being impossible without the
...
[T-167](../../TODO/bep-coverage.md) was blocked on BEP 54 having no receive side upstream;
...
[T-164](../../TODO/peers.md) is `partial` rather than `blocked` because one of its three
...
## The ordering of 2026-08-21T17:05Z, and the record of what each closing measured

The ordering below was already historical when it was archived: `INDEX.md` kept
it as an example of how the four questions are asked rather than as a work
order. The record under "What is settled" is the evidence the ordering rested
on, and every claim in it also lives in the entry that closed it.

## How an ordering is derived

**This is not the work order.** [PROGRESS.md](../../TODO/PROGRESS.md) carries that, under
...
Three entries were filed out of the measurements: [T-185](../../TODO/cli-surface.md),
[T-186](../../TODO/cli-surface.md) and [T-187](../../TODO/metainfo.md).

**The one that changes this ordering is [T-185](../../TODO/cli-surface.md)**, and it goes
...
third flag-does-nothing defect after [T-181](../../TODO/cli-surface.md) and
[T-183](../../TODO/cli-surface.md), and the first whose cost is measured in bytes fetched
...
1. **[T-185](../../TODO/cli-surface.md)**, **done 2026-08-22T01:40Z.** Both halves of the
...
2. **[T-143](../../TODO/multi-source.md)**, **done 2026-08-22T02:00Z.** The failure above
   ...
   above it closed. [T-005](../../TODO/webseed.md) built the machinery this needs and did
   not use it for this: a bridge reconnects mid-run with a different piece
   list, which is most of what attaching late requires. [T-179](../../TODO/webseed.md)
...
3. **[T-164](../../TODO/peers.md)**, **partial 2026-08-22T02:20Z, and the seam is named.**
   ...
   than under the P0s because [T-179](../../TODO/webseed.md) built everything about it
   ...
   way [T-167](../../TODO/bep-coverage.md) had to. The corpus reference is
   `aria2_rust/aria2-core/src/engine/bt_peer_storage/rejection_state.rs`.

### 3. The open P0 items, and why each is still P0

4. **[T-020](../../TODO/peers.md)**, the only open P0. Two defects; one fixed. What keeps
   ...
   load. [T-164](../../TODO/peers.md) is adjacent and cheap: vortex 125 is a peer
   reconnecting every 20 seconds and burning a slot, which is the same
   resource seen from the other side.
5. **[T-040](../../TODO/memory.md)**, partial, and the open question is answered.
...
6. **[T-090](../../TODO/bench.md)**, partial, with **[T-092](../../TODO/bench.md)** as the residue.
...
7. **[T-064](../../TODO/trackers.md)**, BEP 15 backoff. Nine lines at
...
8. **[T-176](../../TODO/create-seed.md)**, three lints. Two are threshold changes against
    numbers the corpus supplies, and one is splitting a message that is
    currently false.
9. **[T-100](../../TODO/bep-coverage.md)**, BEP 6. The algorithm at
...
10. **[T-081](../../TODO/create-seed.md)**, BEP 52. `nanotorrent`'s 618-line v2 and
...
11. **[T-018](../../TODO/disk-io.md)** and **[T-083](../../TODO/create-seed.md)**. Coalescing with
...
12. **[T-163](../../TODO/peers.md)**, MSE/PE, and it is **done** as of 2026-08-23. It was
    ...
    [T-002](../../TODO/webseed.md) and [T-102](../../TODO/bep-coverage.md), which the vendored tree
    removed: one `StreamTransform` trait, and the encryption itself in this
    repository's own code.
13. **[T-103](../../TODO/bep-coverage.md)**, the `.utf-8` key variants. uTorrent writes
...
14. [T-101](../../TODO/bep-coverage.md) uTP, [T-102](../../TODO/bep-coverage.md) BEP 55,
    [T-168](../../TODO/bep-coverage.md) WebTorrent, [T-169](../../TODO/dht.md) BEP 33 and 51,
    [T-170](../../TODO/dht.md) BEP 44, [T-082](../../TODO/create-seed.md) BEP 16. None of these
...
15. [multi-source.md](../../TODO/multi-source.md) is the operator's five scenarios and
...
- **[T-167](../../TODO/bep-coverage.md)**, BEP 54 `lt_donthave`, newly blocked. The
...
- **[T-163](../../TODO/peers.md)** MSE, **done**, and **[T-102](../../TODO/bep-coverage.md)** BEP 55:
...
- **[T-016](../../TODO/disk-io.md)** fastresume, which was blocked on `librqbit` offering
...
path outranks a visible P0, and it put four items above [T-020](../../TODO/peers.md) on
...
**A P1 found while measuring a P2 outranks the P2.** [T-185](../../TODO/cli-surface.md)
turned up while building [T-184](../../TODO/disk-io.md)'s fixture, and it is a flag that
...
measuring first is what found it.** [T-184](../../TODO/disk-io.md) predicted a selection
...
it belongs to and the piece verifies. [T-172](../../TODO/metainfo.md) recommended
...
[RULES.md](../../TODO/RULES.md) as its own line: measure before building, when the entry
describes what the code does.

**Closing an entry raised two under it.** [T-179](../../TODO/webseed.md) built the block
ledger, and it is now the reason [T-164](../../TODO/peers.md) is priced at "read the seam
first" rather than "design the machinery", and part of why
[T-143](../../TODO/multi-source.md) is smaller than it was. That is the same movement
[T-005](../../TODO/webseed.md) made for T-179 in the previous derivation.
...
1. [T-084](../../TODO/create-seed.md) is **done**. `bit-cli create`, `verify`, and `seed`
   ...
   hybrid` case is still uncovered and waits on [T-081](../../TODO/create-seed.md).
2. [T-071](../../TODO/windows.md) and [T-072](../../TODO/windows.md) are **done**. Every torrent path
   ...
   fixed too.
3. [T-091](../../TODO/bench.md), [T-042](../../TODO/memory.md), [T-093](../../TODO/bench.md) and
   [T-090](../../TODO/bench.md) are all **done**. Every `bench` report carries the
   ...
   [T-092](../../TODO/bench.md) is **done** as of 2026-08-22 and was the last of T-090.
...
4. [T-001](../../TODO/webseed.md) is **done**, and so is [T-006](../../TODO/webseed.md).
   ...
   **The bridge costs about five sixths of the available throughput, and the
   ...
   [T-017](../../TODO/disk-io.md) measured that separately and found it is not: storage
   moves 1.31 GiB/s at eight writers on one file, which is 3.3 times what the
   eight-bridge run asks of it.

   The fix the measurement points at is [T-009](../../TODO/webseed.md), and it is
   **done**. `--web-seed-connections <N>` presents one source over N
   ...
   [T-002](../../TODO/webseed.md) is **done** and the answer is no: `librqbit` 9.0.0 has
...
5. The disk I/O cluster. [T-010](../../TODO/disk-io.md), [T-011](../../TODO/disk-io.md),
   [T-012](../../TODO/disk-io.md), [T-013](../../TODO/disk-io.md), [T-014](../../TODO/disk-io.md), and
   [T-015](../../TODO/disk-io.md) are **done**, and so are the two Windows items that
   depended on the same storage, [T-070](../../TODO/windows.md) and
   [T-076](../../TODO/windows.md). [T-016](../../TODO/disk-io.md) was blocked upstream and is done.
...
6. [T-003](../../TODO/webseed.md) and [T-035](../../TODO/performance.md) are **done**.
   ...
   [T-032](../../TODO/performance.md) and [T-141](../../TODO/webseed.md) are **done**, and both
...
7. The long-run failures. [T-017](../../TODO/disk-io.md), [T-030](../../TODO/performance.md),
   [T-021](../../TODO/peers.md), [T-031](../../TODO/performance.md), [T-037](../../TODO/performance.md), and
   [T-138](../../TODO/peers.md) are **done**. [T-020](../../TODO/peers.md) is the one open P0 left,
   and [T-040](../../TODO/memory.md) is partial: its question is answered and what is left
   ...
   [T-021](../../TODO/peers.md) does both things its acceptance allows, and which one
   ...
   residue was [T-138](../../TODO/peers.md), and it is **done**: `--redial-after 30s`
   ...
   [T-020](../../TODO/peers.md) was two defects. One is fixed: `librqbit`'s accept loop
   ...
   [T-017](../../TODO/disk-io.md) rules the disk out rather than in. `bit-cli bench disk`
   ...
   residue is [T-018](../../TODO/disk-io.md), worth at most 18%.

   [T-030](../../TODO/performance.md) was real and was two defects, neither of them
   ...
   reported success. That second one is [T-036](../../TODO/performance.md), a P0 in its
   own right, and it is what made the first report look like contention: four
   torrents on one file is exactly the shape [T-017](../../TODO/disk-io.md) measured as
   ...
   [T-037](../../TODO/performance.md) was what was left of [T-030](../../TODO/performance.md): one
   ...
   [T-042](../../TODO/memory.md) built the sampler these need, and `download` and `seed`
   report their own peak RSS, CPU time, and handle count, in the final report
   and in every `progress` event. [T-011](../../TODO/disk-io.md) removed one of the two
   things [T-040](../../TODO/memory.md) names: descriptors are now bounded by a flag.

   [T-040](../../TODO/memory.md) is **partial**, and the open question it carried is
...
8. [multi-source.md](../../TODO/multi-source.md), the operator's five scenarios about
   ...
   **Four of the five work in full, and Scenario 2 now needs no flags at
   all.** [T-131](../../TODO/multi-source.md),
   [T-130](../../TODO/multi-source.md), and [T-137](../../TODO/multi-source.md) are **done**, which
   ...
   that is under [T-131](../../TODO/multi-source.md). And the bridge retired a source on
   ...
   their entries. [T-137](../../TODO/multi-source.md) came out of the second.

   [T-133](../../TODO/multi-source.md) **layers 1 and 2 are done, and Scenario 2 is one
   ...
   [T-140](../../TODO/multi-source.md) closed the rest of layer 3, so **Scenario 2 needs
   ...
   started is [T-143](../../TODO/multi-source.md). And real control of which source
   answers a piece is [T-135](../../TODO/multi-source.md), already priced by
   [T-002](../../TODO/webseed.md) and [T-003](../../TODO/webseed.md).
...
9. [T-113](../../TODO/cli-surface.md) is **done**. `bit-cli download release.meta4` reads
...
10. [T-179](../../TODO/webseed.md), [T-184](../../TODO/disk-io.md), [T-004](../../TODO/webseed.md) and
    [T-172](../../TODO/metainfo.md) are **done**, closed 2026-08-21, and three of the four
    ...
    **`--select-file` says what it writes into the files it did not select.**
    ...
    [T-013](../../TODO/disk-io.md)'s own closing said so. What the measurement found is
