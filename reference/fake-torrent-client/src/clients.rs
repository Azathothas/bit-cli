    ...
    pub fn build(&mut self, client_version: ClientVersion) {
        match client_version {
            ClientVersion::Bittorrent_7_10_1_43917 => {
                ...
                self.peer_pattern =
                    String::from(r"b'-BT71000(\xc2\x8d\xc2\xab)[\x01-\xc3\xbf]{10}'");
                self.uppercase_encoded_hex = false;
                self.num_want = 200;
                self.num_want_on_stop = 0;
            ...
            ClientVersion::Bittorrent_7_10_3_44429 => {
                ...
                self.peer_algorithm = crate::algorithm::Algorithm::Regex;
                self.peer_pattern =
                    String::from(r"b'-BT7a3S-(\xc2\x8d)(\xc2\xad)[\x01-\xc3\xbf]{10}'");
                self.uppercase_encoded_hex = false;
                self.num_want = 200;
                self.num_want_on_stop = 0;
                self.query = String::from("info_hash={infohash}&peer_id={peerid}&port={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&corrupt=0&key={key}&event={event}&numwant={numwant}&compact=1&no_peer_id=1");
            ...
            ClientVersion::Deluge_1_3_13 => {
                ...
                self.peer_algorithm = crate::algorithm::Algorithm::Regex;
                self.peer_pattern =
                    String::from(r"b'-DE13D0-[A-Za-z0-9_~\\\\(\\\\)\\\\!\\\\.\\\\*-]{12}'");
                self.uppercase_encoded_hex = false;
                self.num_want = 200;
                self.num_want_on_stop = 0;
            ...
            ClientVersion::Deluge_1_3_14 => {
                ...
                self.peer_algorithm = crate::algorithm::Algorithm::Regex;
                self.peer_pattern =
                    String::from(r"b'-DE13E0-[A-Za-z0-9_~\\\\(\\\\)\\\\!\\\\.\\\\*-]{12}'");
                self.uppercase_encoded_hex = false;
                self.num_want = 200;
                self.num_want_on_stop = 0;
                self.query = String::from("info_hash={infohash}&peer_id={peerid}&port={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&corrupt=0&key={key}&event={event}&numwant={numwant}&compact=1&no_peer_id=1&supportcrypto=1&redundant=0");
            ...
            ClientVersion::Deluge_1_3_15 => {
                ...
                self.peer_algorithm = crate::algorithm::Algorithm::Regex;
                self.peer_pattern =
                    String::from(r"b'-DE13F0-[A-Za-z0-9_~\\\\(\\\\)\\\\!\\\\.\\\\*-]{12}'");
                self.uppercase_encoded_hex = false;
                self.num_want = 200;
                self.num_want_on_stop = 0;
                self.query = String::from("info_hash={infohash}&peer_id={peerid}&port={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&corrupt=0&key={key}&event={event}&numwant={numwant}&compact=1&no_peer_id=1&supportcrypto=1&redundant=0");
            ...
            ClientVersion::Deluge_2_0_3 => {
                ...
                self.peer_algorithm = crate::algorithm::Algorithm::Regex;
                self.peer_pattern =
                    String::from(r"b'-DE203s-[A-Za-z0-9_~\\\\(\\\\)\\\\!\\\\.\\\\*-]{12}'");
                self.uppercase_encoded_hex = false;
                self.num_want = 200;
                self.num_want_on_stop = 0;
                self.query = String::from("info_hash={infohash}&peer_id={peerid}&port={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&corrupt=0&key={key}&event={event}&numwant={numwant}&compact=1&no_peer_id=1&supportcrypto=1&redundant=0");
            ...
            ClientVersion::Leap_2_6_0_1 => {
                ...
                self.peer_algorithm = crate::algorithm::Algorithm::Regex;
                self.peer_pattern =
                    String::from(r"b'-LT1100-[A-Za-z0-9_~\\\\(\\\\)\\\\!\\\\.\\\\*-]{12}'");
                self.uppercase_encoded_hex = false;
                self.num_want = 200;
                self.num_want_on_stop = 0;
                self.query = String::from("info_hash={infohash}&peer_id={peerid}&port={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&corrupt=0&key={key}&event={event}&numwant={numwant}&compact=1&no_peer_id=1&supportcrypto=1&redundant=0");
            ...
            ClientVersion::Qbittorrent_3_3_1 => {
                ...
                self.peer_algorithm = crate::algorithm::Algorithm::Regex;
                self.peer_pattern =
                    String::from(r"b'-qB3310-[A-Za-z0-9_~\\\\(\\\\)\\\\!\\\\.\\\\*-]{12}'");
                self.uppercase_encoded_hex = false;
                self.num_want = 200;
                self.num_want_on_stop = 0;
                self.query = String::from("info_hash={infohash}&peer_id={peerid}&port={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&corrupt=0&key={key}&event={event}&numwant={numwant}&compact=1&no_peer_id=1&supportcrypto=1&redundant=0");
            ...
            ClientVersion::Qbittorrent_3_3_13 => {
                ...
                self.peer_algorithm = crate::algorithm::Algorithm::Regex;
                self.peer_pattern =
                    String::from(r"b'-qB33D0-[A-Za-z0-9_~\\\\(\\\\)\\\\!\\\\.\\\\*-]{12}'");
                self.uppercase_encoded_hex = false;
                self.num_want = 200;
                self.num_want_on_stop = 0;
                self.query = String::from("info_hash={infohash}&peer_id={peerid}&port={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&corrupt=0&key={key}&event={event}&numwant={numwant}&compact=1&no_peer_id=1&supportcrypto=1&redundant=0");
            ...
            ClientVersion::Qbittorrent_3_3_14 => {
                ...
                self.peer_algorithm = crate::algorithm::Algorithm::Regex;
                self.peer_pattern =
                    String::from(r"b'-qB33E0-[A-Za-z0-9_~\\\\(\\\\)\\\\!\\\\.\\\\*-]{12}'");
                self.uppercase_encoded_hex = false;
                self.num_want = 200;
                self.num_want_on_stop = 0;
                self.query = String::from("info_hash={infohash}&peer_id={peerid}&port={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&corrupt=0&key={key}&event={event}&numwant={numwant}&compact=1&no_peer_id=1&supportcrypto=1&redundant=0");
            ...
            ClientVersion::Qbittorrent_3_3_15 => {
                ...
                self.peer_algorithm = crate::algorithm::Algorithm::Regex;
                self.peer_pattern =
                    String::from(r"b'-qB33F0-[A-Za-z0-9_~\\\\(\\\\)\\\\!\\\\.\\\\*-]{12}'");
                self.uppercase_encoded_hex = false;
                self.num_want = 200;
                self.num_want_on_stop = 0;
                self.query = String::from("info_hash={infohash}&peer_id={peerid}&port={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&corrupt=0&key={key}&event={event}&numwant={numwant}&compact=1&no_peer_id=1&supportcrypto=1&redundant=0");
            ...
            ClientVersion::Qbittorrent_3_3_16 => {
                ...
                self.peer_algorithm = crate::algorithm::Algorithm::Regex;
                self.peer_pattern =
                    String::from(r"b'-qB33G0-[A-Za-z0-9_~\\\\(\\\\)\\\\!\\\\.\\\\*-]{12}'");
                self.uppercase_encoded_hex = false;
                self.num_want = 200;
                self.num_want_on_stop = 0;
                self.query = String::from("info_hash={infohash}&peer_id={peerid}&port={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&corrupt=0&key={key}&event={event}&numwant={numwant}&compact=1&no_peer_id=1&supportcrypto=1&redundant=0");
            ...
            ClientVersion::Qbittorrent_4_0_0 => {
                ...
                self.peer_algorithm = crate::algorithm::Algorithm::Regex;
                self.peer_pattern =
                    String::from(r"b'-qB4000-[A-Za-z0-9_~\\\\(\\\\)\\\\!\\\\.\\\\*-]{12}'");
                self.uppercase_encoded_hex = false;
                self.num_want = 200;
                self.num_want_on_stop = 0;
                self.query = String::from("info_hash={infohash}&peer_id={peerid}&port={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&corrupt=0&key={key}&event={event}&numwant={numwant}&compact=1&no_peer_id=1&supportcrypto=1&redundant=0");
            ...
            ClientVersion::Qbittorrent_4_0_1 => {
                ...
                self.peer_algorithm = crate::algorithm::Algorithm::Regex;
                self.peer_pattern =
                    String::from(r"b'-qB4010-[A-Za-z0-9_~\\\\(\\\\)\\\\!\\\\.\\\\*-]{12}'");
                self.uppercase_encoded_hex = false;
                self.num_want = 200;
                self.num_want_on_stop = 0;
                self.query = String::from("info_hash={infohash}&peer_id={peerid}&port={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&corrupt=0&key={key}&event={event}&numwant={numwant}&compact=1&no_peer_id=1&supportcrypto=1&redundant=0");
            ...
            ClientVersion::Qbittorrent_4_0_2 => {
                ...
                self.peer_algorithm = crate::algorithm::Algorithm::Regex;
                self.peer_pattern =
                    String::from(r"b'-qB4020-[A-Za-z0-9_~\\\\(\\\\)\\\\!\\\\.\\\\*-]{12}'");
                self.uppercase_encoded_hex = false;
                self.num_want = 200;
                self.num_want_on_stop = 0;
                self.query = String::from("info_hash={infohash}&peer_id={peerid}&port={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&corrupt=0&key={key}&event={event}&numwant={numwant}&compact=1&no_peer_id=1&supportcrypto=1&redundant=0");
            ...
            ClientVersion::Qbittorrent_4_0_3 => {
                ...
                self.peer_algorithm = crate::algorithm::Algorithm::Regex;
                self.peer_pattern =
                    String::from(r"b'-qB4030-[A-Za-z0-9_~\\\\(\\\\)\\\\!\\\\.\\\\*-]{12}'");
                self.uppercase_encoded_hex = false;
                self.num_want = 200;
                self.num_want_on_stop = 0;
                self.query = String::from("info_hash={infohash}&peer_id={peerid}&port={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&corrupt=0&key={key}&event={event}&numwant={numwant}&compact=1&no_peer_id=1&supportcrypto=1&redundant=0");
            ...
            ClientVersion::Qbittorrent_4_0_4 => {
                ...
                self.peer_algorithm = crate::algorithm::Algorithm::Regex;
                self.peer_pattern =
                    String::from(r"b'-qB4040-[A-Za-z0-9_~\\\\(\\\\)\\\\!\\\\.\\\\*-]{12}'");
                self.uppercase_encoded_hex = false;
                self.num_want = 200;
                self.num_want_on_stop = 0;
                self.query = String::from("info_hash={infohash}&peer_id={peerid}&port={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&corrupt=0&key={key}&event={event}&numwant={numwant}&compact=1&no_peer_id=1&supportcrypto=1&redundant=0");
            ...
            ClientVersion::Qbittorrent_4_1_0 => {
                ...
                self.peer_algorithm = crate::algorithm::Algorithm::Regex;
                self.peer_pattern =
                    String::from(r"b'-qB4100-[A-Za-z0-9_~\\\\(\\\\)\\\\!\\\\.\\\\*-]{12}'");
                self.uppercase_encoded_hex = false;
                self.num_want = 200;
                self.num_want_on_stop = 0;
                self.query = String::from("info_hash={infohash}&peer_id={peerid}&port={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&corrupt=0&key={key}&event={event}&numwant={numwant}&compact=1&no_peer_id=1&supportcrypto=1&redundant=0");
            ...
            ClientVersion::Qbittorrent_4_1_1 => {
                ...
                self.peer_algorithm = crate::algorithm::Algorithm::Regex;
                self.peer_pattern =
                    String::from(r"b'-qB4110-[A-Za-z0-9_~\\\\(\\\\)\\\\!\\\\.\\\\*-]{12}'");
                self.uppercase_encoded_hex = false;
                self.num_want = 200;
                self.num_want_on_stop = 0;
                self.query = String::from("info_hash={infohash}&peer_id={peerid}&port={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&corrupt=0&key={key}&event={event}&numwant={numwant}&compact=1&no_peer_id=1&supportcrypto=1&redundant=0");
            ...
            ClientVersion::Qbittorrent_4_1_2 => {
                ...
                self.peer_algorithm = crate::algorithm::Algorithm::Regex;
                self.peer_pattern =
                    String::from(r"b'-qB4120-[A-Za-z0-9_~\\\\(\\\\)\\\\!\\\\.\\\\*-]{12}'");
                self.uppercase_encoded_hex = false;
                self.num_want = 200;
                self.num_want_on_stop = 0;
                self.query = String::from("info_hash={infohash}&peer_id={peerid}&port={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&corrupt=0&key={key}&event={event}&numwant={numwant}&compact=1&no_peer_id=1&supportcrypto=1&redundant=0");
            ...
            ClientVersion::Qbittorrent_4_1_3 => {
                ...
                self.peer_algorithm = crate::algorithm::Algorithm::Regex;
                self.peer_pattern =
                    String::from(r"b'-qB4130-[A-Za-z0-9_~\\\\(\\\\)\\\\!\\\\.\\\\*-]{12}'");
                self.uppercase_encoded_hex = false;
                self.num_want = 200;
                self.num_want_on_stop = 0;
                self.query = String::from("info_hash={infohash}&peer_id={peerid}&port={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&corrupt=0&key={key}&event={event}&numwant={numwant}&compact=1&no_peer_id=1&supportcrypto=1&redundant=0");
            ...
            ClientVersion::Qbittorrent_4_1_4 => {
                ...
                self.peer_algorithm = crate::algorithm::Algorithm::Regex;
                self.peer_pattern =
                    String::from(r"b'-qB4140-[A-Za-z0-9_~\\\\(\\\\)\\\\!\\\\.\\\\*-]{12}'");
                self.uppercase_encoded_hex = false;
                self.num_want = 200;
                self.num_want_on_stop = 0;
                self.query = String::from("info_hash={infohash}&peer_id={peerid}&port={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&corrupt=0&key={key}&event={event}&numwant={numwant}&compact=1&no_peer_id=1&supportcrypto=1&redundant=0");
            ...
            ClientVersion::Qbittorrent_4_1_5 => {
                ...
                self.peer_algorithm = crate::algorithm::Algorithm::Regex;
                self.peer_pattern =
                    String::from(r"b'-qB4150-[A-Za-z0-9_~\\\\(\\\\)\\\\!\\\\.\\\\*-]{12}'");
                self.uppercase_encoded_hex = false;
                self.num_want = 200;
                self.num_want_on_stop = 0;
                self.query = String::from("info_hash={infohash}&peer_id={peerid}&port={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&corrupt=0&key={key}&event={event}&numwant={numwant}&compact=1&no_peer_id=1&supportcrypto=1&redundant=0");
            ...
            ClientVersion::Qbittorrent_4_1_6 => {
                ...
                self.peer_algorithm = crate::algorithm::Algorithm::Regex;
                self.peer_pattern =
                    String::from(r"b'-qB4160-[A-Za-z0-9_~\\\\(\\\\)\\\\!\\\\.\\\\*-]{12}'");
                self.uppercase_encoded_hex = false;
                self.num_want = 200;
                self.num_want_on_stop = 0;
                self.query = String::from("info_hash={infohash}&peer_id={peerid}&port={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&corrupt=0&key={key}&event={event}&numwant={numwant}&compact=1&no_peer_id=1&supportcrypto=1&redundant=0");
            ...
            ClientVersion::Qbittorrent_4_1_7 => {
                ...
                self.peer_algorithm = crate::algorithm::Algorithm::Regex;
                self.peer_pattern =
                    String::from(r"b'-qB4170-[A-Za-z0-9_~\\\\(\\\\)\\\\!\\\\.\\\\*-]{12}'");
                self.uppercase_encoded_hex = false;
                self.num_want = 200;
                self.num_want_on_stop = 0;
                self.query = String::from("info_hash={infohash}&peer_id={peerid}&port={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&corrupt=0&key={key}&event={event}&numwant={numwant}&compact=1&no_peer_id=1&supportcrypto=1&redundant=0");
            ...
            ClientVersion::Qbittorrent_4_1_8 => {
                ...
                self.peer_algorithm = crate::algorithm::Algorithm::Regex;
                self.peer_pattern =
                    String::from(r"b'-qB4180-[A-Za-z0-9_~\\\\(\\\\)\\\\!\\\\.\\\\*-]{12}'");
                self.uppercase_encoded_hex = false;
                self.num_want = 200;
                self.num_want_on_stop = 0;
                self.query = String::from("info_hash={infohash}&peer_id={peerid}&port={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&corrupt=0&key={key}&event={event}&numwant={numwant}&compact=1&no_peer_id=1&supportcrypto=1&redundant=0");
            ...
            ClientVersion::Qbittorrent_4_1_9 => {
                ...
                self.peer_algorithm = crate::algorithm::Algorithm::Regex;
                self.peer_pattern =
                    String::from(r"b'-qB4190-[A-Za-z0-9_~\\\\(\\\\)\\\\!\\\\.\\\\*-]{12}'");
                self.uppercase_encoded_hex = false;
                self.num_want = 200;
                self.num_want_on_stop = 0;
                self.query = String::from("info_hash={infohash}&peer_id={peerid}&port={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&corrupt=0&key={key}&event={event}&numwant={numwant}&compact=1&no_peer_id=1&supportcrypto=1&redundant=0");
            ...
            ClientVersion::Qbittorrent_4_2_0 => {
                ...
                self.peer_algorithm = crate::algorithm::Algorithm::Regex;
                self.peer_pattern =
                    String::from(r"b'-qB4200-[A-Za-z0-9_~\\\\(\\\\)\\\\!\\\\.\\\\*-]{12}'");
                self.uppercase_encoded_hex = false;
                self.num_want = 200;
                self.num_want_on_stop = 0;
                self.query = String::from("info_hash={infohash}&peer_id={peerid}&port={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&corrupt=0&key={key}&event={event}&numwant={numwant}&compact=1&no_peer_id=1&supportcrypto=1&redundant=0");
            ...
            ClientVersion::Qbittorrent_4_2_1 => {
                ...
                self.peer_algorithm = crate::algorithm::Algorithm::Regex;
                self.peer_pattern =
                    String::from(r"b'-qB4210-[A-Za-z0-9_~\\\\(\\\\)\\\\!\\\\.\\\\*-]{12}'");
                self.uppercase_encoded_hex = false;
                self.num_want = 200;
                self.num_want_on_stop = 0;
                self.query = String::from("info_hash={infohash}&peer_id={peerid}&port={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&corrupt=0&key={key}&event={event}&numwant={numwant}&compact=1&no_peer_id=1&supportcrypto=1&redundant=0");
            ...
            ClientVersion::Qbittorrent_4_2_2 => {
                ...
                self.peer_algorithm = crate::algorithm::Algorithm::Regex;
                self.peer_pattern =
                    String::from(r"b'-qB4220-[A-Za-z0-9_~\\\\(\\\\)\\\\!\\\\.\\\\*-]{12}'");
                self.uppercase_encoded_hex = false;
                self.num_want = 200;
                self.num_want_on_stop = 0;
                self.query = String::from("info_hash={infohash}&peer_id={peerid}&port={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&corrupt=0&key={key}&event={event}&numwant={numwant}&compact=1&no_peer_id=1&supportcrypto=1&redundant=0");
            ...
            ClientVersion::Qbittorrent_4_2_3 => {
                ...
                self.peer_algorithm = crate::algorithm::Algorithm::Regex;
                self.peer_pattern =
                    String::from(r"b'-qB4230-[A-Za-z0-9_~\\\\(\\\\)\\\\!\\\\.\\\\*-]{12}'");
                self.uppercase_encoded_hex = false;
                self.num_want = 200;
                self.num_want_on_stop = 0;
                self.query = String::from("info_hash={infohash}&peer_id={peerid}&port={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&corrupt=0&key={key}&event={event}&numwant={numwant}&compact=1&no_peer_id=1&supportcrypto=1&redundant=0");
            ...
            ClientVersion::Qbittorrent_4_2_4 => {
                ...
                self.peer_algorithm = crate::algorithm::Algorithm::Regex;
                self.peer_pattern =
                    String::from(r"b'-qB4240-[A-Za-z0-9_~\\\\(\\\\)\\\\!\\\\.\\\\*-]{12}'");
                self.uppercase_encoded_hex = false;
                self.num_want = 200;
                self.num_want_on_stop = 0;
                self.query = String::from("info_hash={infohash}&peer_id={peerid}&port={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&corrupt=0&key={key}&event={event}&numwant={numwant}&compact=1&no_peer_id=1&supportcrypto=1&redundant=0");
            ...
            ClientVersion::Qbittorrent_4_2_5 => {
                ...
                self.peer_algorithm = crate::algorithm::Algorithm::Regex;
                self.peer_pattern =
                    String::from(r"b'-qB4250-[A-Za-z0-9_~\\\\(\\\\)\\\\!\\\\.\\\\*-]{12}'");
                self.uppercase_encoded_hex = false;
                self.num_want = 200;
                self.num_want_on_stop = 0;
                self.query = String::from("info_hash={infohash}&peer_id={peerid}&port={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&corrupt=0&key={key}&event={event}&numwant={numwant}&compact=1&no_peer_id=1&supportcrypto=1&redundant=0");
            ...
            ClientVersion::Qbittorrent_4_3_0_1 => {
                ...
                self.peer_algorithm = crate::algorithm::Algorithm::Regex;
                self.peer_pattern =
                    String::from(r"b'-qB4301-[A-Za-z0-9_~\\\\(\\\\)\\\\!\\\\.\\\\*-]{12}'");
                self.uppercase_encoded_hex = false;
                self.num_want = 200;
                self.num_want_on_stop = 0;
                self.query = String::from("info_hash={infohash}&peer_id={peerid}&port={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&corrupt=0&key={key}&event={event}&numwant={numwant}&compact=1&no_peer_id=1&supportcrypto=1&redundant=0");
            ...
            ClientVersion::Qbittorrent_4_3_0 => {
                ...
                self.peer_algorithm = crate::algorithm::Algorithm::Regex;
                self.peer_pattern =
                    String::from(r"b'-qB4300-[A-Za-z0-9_~\\\\(\\\\)\\\\!\\\\.\\\\*-]{12}'");
                self.uppercase_encoded_hex = false;
                self.num_want = 200;
                self.num_want_on_stop = 0;
                self.query = String::from("info_hash={infohash}&peer_id={peerid}&port={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&corrupt=0&key={key}&event={event}&numwant={numwant}&compact=1&no_peer_id=1&supportcrypto=1&redundant=0");
            ...
            ClientVersion::Qbittorrent_4_3_1 => {
                ...
                self.peer_algorithm = crate::algorithm::Algorithm::Regex;
                self.peer_pattern =
                    String::from(r"b'-qB4310-[A-Za-z0-9_~\\\\(\\\\)\\\\!\\\\.\\\\*-]{12}'");
                self.uppercase_encoded_hex = false;
                self.num_want = 200;
                self.num_want_on_stop = 0;
                self.query = String::from("info_hash={infohash}&peer_id={peerid}&port={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&corrupt=0&key={key}&event={event}&numwant={numwant}&compact=1&no_peer_id=1&supportcrypto=1&redundant=0");
            ...
            ClientVersion::Qbittorrent_4_3_2 => {
                ...
                self.peer_algorithm = crate::algorithm::Algorithm::Regex;
                self.peer_pattern =
                    String::from(r"b'-qB4320-[A-Za-z0-9_~\\\\(\\\\)\\\\!\\\\.\\\\*-]{12}'");
                self.uppercase_encoded_hex = false;
                self.num_want = 200;
                self.num_want_on_stop = 0;
                self.query = String::from("info_hash={infohash}&peer_id={peerid}&port={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&corrupt=0&key={key}&event={event}&numwant={numwant}&compact=1&no_peer_id=1&supportcrypto=1&redundant=0");
            ...
            ClientVersion::Qbittorrent_4_3_3 => {
                ...
                self.peer_algorithm = crate::algorithm::Algorithm::Regex;
                self.peer_pattern =
                    String::from(r"b'-qB4330-[A-Za-z0-9_~\\\\(\\\\)\\\\!\\\\.\\\\*-]{12}'");
                self.uppercase_encoded_hex = false;
                self.num_want = 200;
                self.num_want_on_stop = 0;
                self.query = String::from("info_hash={infohash}&peer_id={peerid}&port={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&corrupt=0&key={key}&event={event}&numwant={numwant}&compact=1&no_peer_id=1&supportcrypto=1&redundant=0");
            ...
            ClientVersion::Qbittorrent_4_3_4_1 => {
                ...
                self.peer_algorithm = crate::algorithm::Algorithm::Regex;
                self.peer_pattern =
                    String::from(r"b'-qB4341-[A-Za-z0-9_~\\\\(\\\\)\\\\!\\\\.\\\\*-]{12}'");
                self.uppercase_encoded_hex = false;
                self.num_want = 200;
                self.num_want_on_stop = 0;
                self.query = String::from("info_hash={infohash}&peer_id={peerid}&port={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&corrupt=0&key={key}&event={event}&numwant={numwant}&compact=1&no_peer_id=1&supportcrypto=1&redundant=0");
            ...
            ClientVersion::Qbittorrent_4_3_5 => {
                ...
                self.peer_algorithm = crate::algorithm::Algorithm::Regex;
                self.peer_pattern =
                    String::from(r"b'-qB4350-[A-Za-z0-9_~\\\\(\\\\)\\\\!\\\\.\\\\*-]{12}'");
                self.uppercase_encoded_hex = false;
                self.num_want = 200;
                self.num_want_on_stop = 0;
                self.query = String::from("info_hash={infohash}&peer_id={peerid}&port={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&corrupt=0&key={key}&event={event}&numwant={numwant}&compact=1&no_peer_id=1&supportcrypto=1&redundant=0");
            ...
            ClientVersion::Qbittorrent_4_3_6 => {
                ...
                self.peer_algorithm = crate::algorithm::Algorithm::Regex;
                self.peer_pattern =
                    String::from(r"b'-qB4360-[A-Za-z0-9_~\\\\(\\\\)\\\\!\\\\.\\\\*-]{12}'");
                self.uppercase_encoded_hex = false;
                self.num_want = 200;
                self.num_want_on_stop = 0;
                self.query = String::from("info_hash={infohash}&peer_id={peerid}&port={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&corrupt=0&key={key}&event={event}&numwant={numwant}&compact=1&no_peer_id=1&supportcrypto=1&redundant=0");
            ...
            ClientVersion::Qbittorrent_4_3_8 => {
                ...
                self.peer_algorithm = crate::algorithm::Algorithm::Regex;
                self.peer_pattern =
                    String::from(r"b'-qB4380-[A-Za-z0-9_~\\\\(\\\\)\\\\!\\\\.\\\\*-]{12}'");
                self.uppercase_encoded_hex = false;
                self.num_want = 200;
                self.num_want_on_stop = 0;
                self.query = String::from("info_hash={infohash}&peer_id={peerid}&port={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&corrupt=0&key={key}&event={event}&numwant={numwant}&compact=1&no_peer_id=1&supportcrypto=1&redundant=0");
            ...
            ClientVersion::Qbittorrent_4_3_9 => {
                ...
                self.peer_algorithm = crate::algorithm::Algorithm::Regex;
                self.peer_pattern =
                    String::from(r"b'-qB4390-[A-Za-z0-9_~\\\\(\\\\)\\\\!\\\\.\\\\*-]{12}'");
                self.uppercase_encoded_hex = false;
                self.num_want = 200;
                self.num_want_on_stop = 0;
                self.query = String::from("info_hash={infohash}&peer_id={peerid}&port={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&corrupt=0&key={key}&event={event}&numwant={numwant}&compact=1&no_peer_id=1&supportcrypto=1&redundant=0");
            ...
            ClientVersion::Qbittorrent_4_4_2 => {
                ...
                self.peer_algorithm = crate::algorithm::Algorithm::Regex;
                self.peer_pattern =
                    String::from(r"b'-qB4420-[A-Za-z0-9_~\\\\(\\\\)\\\\!\\\\.\\\\*-]{12}'");
                self.uppercase_encoded_hex = false;
                self.num_want = 200;
                self.num_want_on_stop = 0;
                self.query = String::from("info_hash={infohash}&peer_id={peerid}&port={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&corrupt=0&key={key}&event={event}&numwant={numwant}&compact=1&no_peer_id=1&supportcrypto=1&redundant=0");
            ...
            ClientVersion::Qbittorrent_4_4_3_1 => {
                ...
                self.peer_algorithm = crate::algorithm::Algorithm::Regex;
                self.peer_pattern =
                    String::from(r"b'-qB4431-[A-Za-z0-9_~\\\\(\\\\)\\\\!\\\\.\\\\*-]{12}'");
                self.uppercase_encoded_hex = false;
                self.num_want = 200;
                self.num_want_on_stop = 0;
                self.query = String::from("info_hash={infohash}&peer_id={peerid}&port={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&corrupt=0&key={key}&event={event}&numwant={numwant}&compact=1&no_peer_id=1&supportcrypto=1&redundant=0");
            ...
            ClientVersion::Qbittorrent_4_4_4 => {
                self.name = String::from("qbittorrent-4.4.4");
                self.key_algorithm = crate::algorithm::Algorithm::HashNoLeadingZero;
                self.key_uppercase = Some(true);
                self.key_refresh_on = crate::RefreshInterval::TorrentPersistent;
                self.peer_algorithm = crate::algorithm::Algorithm::Regex;
                self.peer_pattern =
                    String::from(r"b'-qB4440-[A-Za-z0-9_~\\\\(\\\\)\\\\!\\\\.\\\\*-]{12}'");
                self.uppercase_encoded_hex = false;
                self.num_want = 200;
                self.num_want_on_stop = 0;
                self.query = String::from("info_hash={infohash}&peer_id={peerid}&port={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&corrupt=0&key={key}&event={event}&numwant={numwant}&compact=1&no_peer_id=1&supportcrypto=1&redundant=0");
                self.encoding_exclusion_pattern =
                    String::from(r"b'[A-Za-z0-9_~\\\\(\\\\)\\\\!\\\\.\\\\*-]'");
                self.peer_url_encode = false;
                self.user_agent = String::from("qBittorrent/4.4.4");
                self.accept_encoding = String::from("gzip");
                self.connection = Some(String::from("close"));
                self.accept_language = String::from("");
            }
            ClientVersion::Qbittorrent_4_4_5 => {
                self.name = String::from("qbittorrent-4.4.5");
                self.key_algorithm = crate::algorithm::Algorithm::HashNoLeadingZero;
                self.key_uppercase = Some(true);
                self.key_refresh_on = crate::RefreshInterval::TorrentPersistent;
                self.peer_algorithm = crate::algorithm::Algorithm::Regex;
                self.peer_pattern =
                    String::from(r"b'-qB4450-[A-Za-z0-9_~\\\\(\\\\)\\\\!\\\\.\\\\*-]{12}'");
                self.uppercase_encoded_hex = false;
                self.num_want = 200;
                self.num_want_on_stop = 0;
                self.query = String::from("info_hash={infohash}&peer_id={peerid}&port={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&corrupt=0&key={key}&event={event}&numwant={numwant}&compact=1&no_peer_id=1&supportcrypto=1&redundant=0");
                self.encoding_exclusion_pattern =
                    String::from(r"b'[A-Za-z0-9_~\\\\(\\\\)\\\\!\\\\.\\\\*-]'");
                self.peer_url_encode = false;
                self.user_agent = String::from("qBittorrent/4.4.5");
                self.accept_encoding = String::from("gzip");
                self.connection = Some(String::from("close"));
                self.accept_language = String::from("");
            }
            ClientVersion::Qbittorrent_4_5_0 => {
                self.name = String::from("qbittorrent-4.5.0");
                self.key_algorithm = crate::algorithm::Algorithm::HashNoLeadingZero;
                self.key_uppercase = Some(true);
                self.key_refresh_on = crate::RefreshInterval::TorrentPersistent;
                self.peer_algorithm = crate::algorithm::Algorithm::Regex;
                self.peer_pattern =
                    String::from(r"b'-qB4500-[A-Za-z0-9_~\\\\(\\\\)\\\\!\\\\.\\\\*-]{12}'");
                self.uppercase_encoded_hex = false;
                self.num_want = 200;
                self.num_want_on_stop = 0;
                self.query = String::from("info_hash={infohash}&peer_id={peerid}&port={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&corrupt=0&key={key}&event={event}&numwant={numwant}&compact=1&no_peer_id=1&supportcrypto=1&redundant=0");
                self.encoding_exclusion_pattern =
                    String::from(r"b'[A-Za-z0-9_~\\\\(\\\\)\\\\!\\\\.\\\\*-]'");
                self.peer_url_encode = false;
                self.user_agent = String::from("qBittorrent/4.5.0");
                self.accept_encoding = String::from("gzip");
                self.connection = Some(String::from("close"));
                self.accept_language = String::from("");
            }
            ClientVersion::Qbittorrent_4_5_1 => {
                self.name = String::from("qbittorrent-4.5.1");
                self.key_algorithm = crate::algorithm::Algorithm::HashNoLeadingZero;
                self.key_uppercase = Some(true);
                self.key_refresh_on = crate::RefreshInterval::TorrentPersistent;
                self.peer_algorithm = crate::algorithm::Algorithm::Regex;
                self.peer_pattern =
                    String::from(r"b'-qB4510-[A-Za-z0-9_~\\\\(\\\\)\\\\!\\\\.\\\\*-]{12}'");
                self.uppercase_encoded_hex = false;
                self.num_want = 200;
                self.num_want_on_stop = 0;
                self.query = String::from("info_hash={infohash}&peer_id={peerid}&port={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&corrupt=0&key={key}&event={event}&numwant={numwant}&compact=1&no_peer_id=1&supportcrypto=1&redundant=0");
                self.encoding_exclusion_pattern =
                    String::from(r"b'[A-Za-z0-9_~\\\\(\\\\)\\\\!\\\\.\\\\*-]'");
                self.peer_url_encode = false;
                self.user_agent = String::from("qBittorrent/4.5.1");
                self.accept_encoding = String::from("gzip");
                self.connection = Some(String::from("close"));
                self.accept_language = String::from("");
            }
            ClientVersion::Qbittorrent_4_5_4 => {
                self.name = String::from("qbittorrent-4.5.4");
                self.key_algorithm = crate::algorithm::Algorithm::HashNoLeadingZero;
                self.key_uppercase = Some(true);
                self.key_refresh_on = crate::RefreshInterval::TorrentPersistent;
                self.peer_algorithm = crate::algorithm::Algorithm::Regex;
                self.peer_pattern =
                    String::from(r"b'-qB4540-[A-Za-z0-9_~\\\\(\\\\)\\\\!\\\\.\\\\*-]{12}'");
                self.uppercase_encoded_hex = false;
                self.num_want = 200;
                self.num_want_on_stop = 0;
                self.query = String::from("info_hash={infohash}&peer_id={peerid}&port={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&corrupt=0&key={key}&event={event}&numwant={numwant}&compact=1&no_peer_id=1&supportcrypto=1&redundant=0");
                self.encoding_exclusion_pattern =
                    String::from(r"b'[A-Za-z0-9_~\\\\(\\\\)\\\\!\\\\.\\\\*-]'");
                self.peer_url_encode = false;
                self.user_agent = String::from("qBittorrent/4.5.4");
                self.accept_encoding = String::from("gzip");
                self.connection = Some(String::from("close"));
                self.accept_language = String::from("");
            }
            ClientVersion::Qbittorrent_4_6_0 => {
                self.name = String::from("qbittorrent-4.6.0");
                self.key_algorithm = crate::algorithm::Algorithm::HashNoLeadingZero;
                self.key_uppercase = Some(true);
                self.key_refresh_on = crate::RefreshInterval::TorrentPersistent;
                self.peer_algorithm = crate::algorithm::Algorithm::Regex;
                self.peer_pattern =
                    String::from(r"b'-qB4600-[A-Za-z0-9_~\\\\(\\\\)\\\\!\\\\.\\\\*-]{12}'");
                self.uppercase_encoded_hex = false;
                self.num_want = 200;
                self.num_want_on_stop = 0;
                self.query = String::from("info_hash={infohash}&peer_id={peerid}&port={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&corrupt=0&key={key}&event={event}&numwant={numwant}&compact=1&no_peer_id=1&supportcrypto=1&redundant=0");
                self.encoding_exclusion_pattern =
                    String::from(r"b'[A-Za-z0-9_~\\\\(\\\\)\\\\!\\\\.\\\\*-]'");
                self.peer_url_encode = false;
                self.user_agent = String::from("qBittorrent/4.6.0");
                self.accept_encoding = String::from("gzip");
                self.connection = Some(String::from("close"));
                self.accept_language = String::from("");
            }
            ClientVersion::Qbittorrent_4_6_3 => {
                self.name = String::from("qbittorrent-4.6.3");
                self.key_algorithm = crate::algorithm::Algorithm::HashNoLeadingZero;
                self.key_uppercase = Some(true);
                self.key_refresh_on = crate::RefreshInterval::TorrentPersistent;
                self.peer_algorithm = crate::algorithm::Algorithm::Regex;
                self.peer_pattern =
                    String::from(r"b'-qB4630-[A-Za-z0-9_~\\\\(\\\\)\\\\!\\\\.\\\\*-]{12}'");
                self.uppercase_encoded_hex = false;
                self.num_want = 200;
                self.num_want_on_stop = 0;
                self.query = String::from("info_hash={infohash}&peer_id={peerid}&port={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&corrupt=0&key={key}&event={event}&numwant={numwant}&compact=1&no_peer_id=1&supportcrypto=1&redundant=0");
                self.encoding_exclusion_pattern =
                    String::from(r"b'[A-Za-z0-9_~\\\\(\\\\)\\\\!\\\\.\\\\*-]'");
                self.peer_url_encode = false;
                self.user_agent = String::from("qBittorrent/4.6.3");
                self.accept_encoding = String::from("gzip");
                self.connection = Some(String::from("close"));
                self.accept_language = String::from("");
            }
            ClientVersion::Qbittorrent_4_6_5 => {
                self.name = String::from("qbittorrent-4.6.5");
                self.key_algorithm = crate::algorithm::Algorithm::HashNoLeadingZero;
                self.key_uppercase = Some(true);
                self.key_refresh_on = crate::RefreshInterval::TorrentPersistent;
                self.peer_algorithm = crate::algorithm::Algorithm::Regex;
                self.peer_pattern =
                    String::from(r"b'-qB4650-[A-Za-z0-9_~\\\\(\\\\)\\\\!\\\\.\\\\*-]{12}'");
                self.uppercase_encoded_hex = false;
                self.num_want = 200;
                self.num_want_on_stop = 0;
                self.query = String::from("info_hash={infohash}&peer_id={peerid}&port={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&corrupt=0&key={key}&event={event}&numwant={numwant}&compact=1&no_peer_id=1&supportcrypto=1&redundant=0");
                self.encoding_exclusion_pattern =
                    String::from(r"b'[A-Za-z0-9_~\\\\(\\\\)\\\\!\\\\.\\\\*-]'");
                self.peer_url_encode = false;
                self.user_agent = String::from("qBittorrent/4.6.5");
                self.accept_encoding = String::from("gzip");
                self.connection = Some(String::from("close"));
                self.accept_language = String::from("");
            }
            ClientVersion::Qbittorrent_4_6_7 => {
                self.name = String::from("qbittorrent-4.6.7");
                self.key_algorithm = crate::algorithm::Algorithm::HashNoLeadingZero;
                self.key_uppercase = Some(true);
                self.key_refresh_on = crate::RefreshInterval::TorrentPersistent;
                self.peer_algorithm = crate::algorithm::Algorithm::Regex;
                self.peer_pattern =
                    String::from(r"b'-qB4670-[A-Za-z0-9_~\\\\(\\\\)\\\\!\\\\.\\\\*-]{12}'");
                self.uppercase_encoded_hex = false;
                self.num_want = 200;
                self.num_want_on_stop = 0;
                self.query = String::from("info_hash={infohash}&peer_id={peerid}&port={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&corrupt=0&key={key}&event={event}&numwant={numwant}&compact=1&no_peer_id=1&supportcrypto=1&redundant=0");
                self.encoding_exclusion_pattern =
                    String::from(r"b'[A-Za-z0-9_~\\\\(\\\\)\\\\!\\\\.\\\\*-]'");
                self.peer_url_encode = false;
                self.user_agent = String::from("qBittorrent/4.6.7");
                self.accept_encoding = String::from("gzip");
                self.connection = Some(String::from("close"));
                self.accept_language = String::from("");
            }
            // 5+ are copy-pasted from 4.6.7, upgraded version but not checked in sources
            ClientVersion::Qbittorrent_5_0_0 => {
                self.name = String::from("qbittorrent-5.0.0");
                self.key_algorithm = crate::algorithm::Algorithm::HashNoLeadingZero;
                self.key_uppercase = Some(true);
                self.key_refresh_on = crate::RefreshInterval::TorrentPersistent;
                self.peer_algorithm = crate::algorithm::Algorithm::Regex;
                self.peer_pattern =
                    String::from(r"b'-qB5000-[A-Za-z0-9_~\\\\(\\\\)\\\\!\\\\.\\\\*-]{12}'");
                self.uppercase_encoded_hex = false;
                self.num_want = 200;
                self.num_want_on_stop = 0;
                self.query = String::from("info_hash={infohash}&peer_id={peerid}&port={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&corrupt=0&key={key}&event={event}&numwant={numwant}&compact=1&no_peer_id=1&supportcrypto=1&redundant=0");
                self.encoding_exclusion_pattern =
                    String::from(r"b'[A-Za-z0-9_~\\\\(\\\\)\\\\!\\\\.\\\\*-]'");
                self.peer_url_encode = false;
                self.user_agent = String::from("qBittorrent/5.0.0");
                self.accept_encoding = String::from("gzip");
                self.connection = Some(String::from("close"));
                self.accept_language = String::from("");
            }
            ClientVersion::Qbittorrent_5_0_1 => {
                self.name = String::from("qbittorrent-5.0.1");
                self.key_algorithm = crate::algorithm::Algorithm::HashNoLeadingZero;
                self.key_uppercase = Some(true);
                self.key_refresh_on = crate::RefreshInterval::TorrentPersistent;
                self.peer_algorithm = crate::algorithm::Algorithm::Regex;
                self.peer_pattern =
                    String::from(r"b'-qB5010-[A-Za-z0-9_~\\\\(\\\\)\\\\!\\\\.\\\\*-]{12}'");
                self.uppercase_encoded_hex = false;
                self.num_want = 200;
                self.num_want_on_stop = 0;
                self.query = String::from("info_hash={infohash}&peer_id={peerid}&port={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&corrupt=0&key={key}&event={event}&numwant={numwant}&compact=1&no_peer_id=1&supportcrypto=1&redundant=0");
                self.encoding_exclusion_pattern =
                    String::from(r"b'[A-Za-z0-9_~\\\\(\\\\)\\\\!\\\\.\\\\*-]'");
                self.peer_url_encode = false;
                self.user_agent = String::from("qBittorrent/5.0.1");
                self.accept_encoding = String::from("gzip");
                self.connection = Some(String::from("close"));
                self.accept_language = String::from("");
            }
            ClientVersion::Qbittorrent_5_0_2 => {
                self.name = String::from("qbittorrent-5.0.2");
                self.key_algorithm = crate::algorithm::Algorithm::HashNoLeadingZero;
                self.key_uppercase = Some(true);
                self.key_refresh_on = crate::RefreshInterval::TorrentPersistent;
                self.peer_algorithm = crate::algorithm::Algorithm::Regex;
                self.peer_pattern =
                    String::from(r"b'-qB5020-[A-Za-z0-9_~\\\\(\\\\)\\\\!\\\\.\\\\*-]{12}'");
                self.uppercase_encoded_hex = false;
                self.num_want = 200;
                self.num_want_on_stop = 0;
                self.query = String::from("info_hash={infohash}&peer_id={peerid}&port={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&corrupt=0&key={key}&event={event}&numwant={numwant}&compact=1&no_peer_id=1&supportcrypto=1&redundant=0");
                self.encoding_exclusion_pattern =
                    String::from(r"b'[A-Za-z0-9_~\\\\(\\\\)\\\\!\\\\.\\\\*-]'");
                self.peer_url_encode = false;
                self.user_agent = String::from("qBittorrent/5.0.2");
                self.accept_encoding = String::from("gzip");
                self.connection = Some(String::from("close"));
                self.accept_language = String::from("");
            }
            ClientVersion::Qbittorrent_5_0_3 => {
                self.name = String::from("qbittorrent-5.0.3");
                self.key_algorithm = crate::algorithm::Algorithm::HashNoLeadingZero;
                self.key_uppercase = Some(true);
                self.key_refresh_on = crate::RefreshInterval::TorrentPersistent;
                self.peer_algorithm = crate::algorithm::Algorithm::Regex;
                self.peer_pattern =
                    String::from(r"b'-qB5030-[A-Za-z0-9_~\\\\(\\\\)\\\\!\\\\.\\\\*-]{12}'");
                self.uppercase_encoded_hex = false;
                self.num_want = 200;
                self.num_want_on_stop = 0;
                self.query = String::from("info_hash={infohash}&peer_id={peerid}&port={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&corrupt=0&key={key}&event={event}&numwant={numwant}&compact=1&no_peer_id=1&supportcrypto=1&redundant=0");
                self.encoding_exclusion_pattern =
                    String::from(r"b'[A-Za-z0-9_~\\\\(\\\\)\\\\!\\\\.\\\\*-]'");
                self.peer_url_encode = false;
                self.user_agent = String::from("qBittorrent/5.0.3");
                self.accept_encoding = String::from("gzip");
                self.connection = Some(String::from("close"));
                self.accept_language = String::from("");
            }
            ClientVersion::Qbittorrent_5_0_4 => {
                self.name = String::from("qbittorrent-5.0.4");
                self.key_algorithm = crate::algorithm::Algorithm::HashNoLeadingZero;
                self.key_uppercase = Some(true);
                self.key_refresh_on = crate::RefreshInterval::TorrentPersistent;
                self.peer_algorithm = crate::algorithm::Algorithm::Regex;
                self.peer_pattern =
                    String::from(r"b'-qB5040-[A-Za-z0-9_~\\\\(\\\\)\\\\!\\\\.\\\\*-]{12}'");
                self.uppercase_encoded_hex = false;
                self.num_want = 200;
                self.num_want_on_stop = 0;
                self.query = String::from("info_hash={infohash}&peer_id={peerid}&port={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&corrupt=0&key={key}&event={event}&numwant={numwant}&compact=1&no_peer_id=1&supportcrypto=1&redundant=0");
                self.encoding_exclusion_pattern =
                    String::from(r"b'[A-Za-z0-9_~\\\\(\\\\)\\\\!\\\\.\\\\*-]'");
                self.peer_url_encode = false;
                self.user_agent = String::from("qBittorrent/5.0.4");
                self.accept_encoding = String::from("gzip");
                self.connection = Some(String::from("close"));
                self.accept_language = String::from("");
            }
            ClientVersion::Qbittorrent_5_0_5 => {
                self.name = String::from("qbittorrent-5.0.5");
                self.key_algorithm = crate::algorithm::Algorithm::HashNoLeadingZero;
                self.key_uppercase = Some(true);
                self.key_refresh_on = crate::RefreshInterval::TorrentPersistent;
                self.peer_algorithm = crate::algorithm::Algorithm::Regex;
                self.peer_pattern =
                    String::from(r"b'-qB5050-[A-Za-z0-9_~\\\\(\\\\)\\\\!\\\\.\\\\*-]{12}'");
                self.uppercase_encoded_hex = false;
                self.num_want = 200;
                self.num_want_on_stop = 0;
                self.query = String::from("info_hash={infohash}&peer_id={peerid}&port={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&corrupt=0&key={key}&event={event}&numwant={numwant}&compact=1&no_peer_id=1&supportcrypto=1&redundant=0");
                self.encoding_exclusion_pattern =
                    String::from(r"b'[A-Za-z0-9_~\\\\(\\\\)\\\\!\\\\.\\\\*-]'");
                self.peer_url_encode = false;
                self.user_agent = String::from("qBittorrent/5.0.5");
                self.accept_encoding = String::from("gzip");
                self.connection = Some(String::from("close"));
                self.accept_language = String::from("");
            }
            ClientVersion::Qbittorrent_5_1_0 => {
                self.name = String::from("qbittorrent-5.1.0");
                self.key_algorithm = crate::algorithm::Algorithm::HashNoLeadingZero;
                self.key_uppercase = Some(true);
                self.key_refresh_on = crate::RefreshInterval::TorrentPersistent;
                self.peer_algorithm = crate::algorithm::Algorithm::Regex;
                self.peer_pattern =
                    String::from(r"b'-qB5100-[A-Za-z0-9_~\\\\(\\\\)\\\\!\\\\.\\\\*-]{12}'");
                self.uppercase_encoded_hex = false;
                self.num_want = 200;
                self.num_want_on_stop = 0;
                self.query = String::from("info_hash={infohash}&peer_id={peerid}&port={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&corrupt=0&key={key}&event={event}&numwant={numwant}&compact=1&no_peer_id=1&supportcrypto=1&redundant=0");
                self.encoding_exclusion_pattern =
                    String::from(r"b'[A-Za-z0-9_~\\\\(\\\\)\\\\!\\\\.\\\\*-]'");
                self.peer_url_encode = false;
                self.user_agent = String::from("qBittorrent/5.1.0");
                self.accept_encoding = String::from("gzip");
                self.connection = Some(String::from("close"));
                self.accept_language = String::from("");
            }
            ...
            ClientVersion::Transmission_2_82_14160 => {
                ...
                self.key_algorithm =
                    crate::algorithm::Algorithm::DigitRangeTransformedToHexWithoutLeadingZeroes;
                self.key_uppercase = Some(false);
            ...
            ClientVersion::Transmission_4_0_0 => {
                self.name = String::from("transmission-4.0.0");
                self.key_algorithm =
                    crate::algorithm::Algorithm::DigitRangeTransformedToHexWithoutLeadingZeroes;
                self.key_uppercase = Some(false);
                self.key_refresh_on = crate::RefreshInterval::Never;
                self.peer_algorithm = crate::algorithm::Algorithm::RandomPoolWithChecksum;
                self.peer_pattern = String::from(r"b'0123456789abcdefghijklmnopqrstuvwxyz'");
                self.peer_prefix = String::from("-TR4000-");
                self.peer_refresh_on = crate::RefreshInterval::TorrentVolatile;
                self.uppercase_encoded_hex = false;
                self.num_want = 80;
                self.num_want_on_stop = 0;
                ...
                self.encoding_exclusion_pattern = String::from(r"b'[A-Za-z0-9-]'");
                self.peer_url_encode = false;
                self.user_agent = String::from("Transmission/4.0.0");
                self.accept_encoding = String::from("deflate, gzip");
                self.accept = String::from("*/*");
                self.accept_language = String::from("");
            }
            ClientVersion::Transmission_4_0_1 => {
                self.name = String::from("transmission-4.0.1");
                self.key_algorithm =
                    crate::algorithm::Algorithm::DigitRangeTransformedToHexWithoutLeadingZeroes;
                self.key_uppercase = Some(false);
                self.key_refresh_on = crate::RefreshInterval::Never;
                self.peer_algorithm = crate::algorithm::Algorithm::RandomPoolWithChecksum;
                self.peer_pattern = String::from(r"b'0123456789abcdefghijklmnopqrstuvwxyz'");
                self.peer_prefix = String::from("-TR4010-");
                self.peer_refresh_on = crate::RefreshInterval::TorrentVolatile;
                self.uppercase_encoded_hex = false;
                self.num_want = 80;
                self.num_want_on_stop = 0;
                ...
                self.encoding_exclusion_pattern = String::from(r"b'[A-Za-z0-9-]'");
                self.peer_url_encode = false;
                self.user_agent = String::from("Transmission/4.0.1");
                self.accept_encoding = String::from("deflate, gzip");
                self.accept = String::from("*/*");
                self.accept_language = String::from("");
            }
            ClientVersion::Transmission_4_0_2 => {
                self.name = String::from("transmission-4.0.2");
                self.key_algorithm =
                    crate::algorithm::Algorithm::DigitRangeTransformedToHexWithoutLeadingZeroes;
                self.key_uppercase = Some(false);
                self.key_refresh_on = crate::RefreshInterval::Never;
                self.peer_algorithm = crate::algorithm::Algorithm::RandomPoolWithChecksum;
                self.peer_pattern = String::from(r"b'0123456789abcdefghijklmnopqrstuvwxyz'");
                self.peer_prefix = String::from("-TR4020-");
                self.peer_refresh_on = crate::RefreshInterval::TorrentVolatile;
                self.uppercase_encoded_hex = false;
                self.num_want = 80;
                self.num_want_on_stop = 0;
                ...
                self.encoding_exclusion_pattern = String::from(r"b'[A-Za-z0-9-]'");
                self.peer_url_encode = false;
                self.user_agent = String::from("Transmission/4.0.2");
                self.accept_encoding = String::from("deflate, gzip");
                self.accept = String::from("*/*");
                self.accept_language = String::from("");
            }
            ClientVersion::Transmission_4_0_3 => {
                self.name = String::from("transmission-4.0.3");
                self.key_algorithm =
                    crate::algorithm::Algorithm::DigitRangeTransformedToHexWithoutLeadingZeroes;
                self.key_uppercase = Some(false);
                self.key_refresh_on = crate::RefreshInterval::Never;
                self.peer_algorithm = crate::algorithm::Algorithm::RandomPoolWithChecksum;
                self.peer_pattern = String::from(r"b'0123456789abcdefghijklmnopqrstuvwxyz'");
                self.peer_prefix = String::from("-TR4030-");
                self.peer_refresh_on = crate::RefreshInterval::TorrentVolatile;
                self.uppercase_encoded_hex = false;
                self.num_want = 80;
                self.num_want_on_stop = 0;
                ...
                self.encoding_exclusion_pattern = String::from(r"b'[A-Za-z0-9-]'");
                self.peer_url_encode = false;
                self.user_agent = String::from("Transmission/4.0.3");
                self.accept_encoding = String::from("deflate, gzip");
                self.accept = String::from("*/*");
                self.accept_language = String::from("");
            }
            ClientVersion::Transmission_4_0_4 => {
                self.name = String::from("transmission-4.0.4");
                self.key_algorithm =
                    crate::algorithm::Algorithm::DigitRangeTransformedToHexWithoutLeadingZeroes;
                self.key_uppercase = Some(false);
                self.key_refresh_on = crate::RefreshInterval::Never;
                self.peer_algorithm = crate::algorithm::Algorithm::RandomPoolWithChecksum;
                self.peer_pattern = String::from(r"b'0123456789abcdefghijklmnopqrstuvwxyz'");
                self.peer_prefix = String::from("-TR4040-");
                self.peer_refresh_on = crate::RefreshInterval::TorrentVolatile;
                self.uppercase_encoded_hex = false;
                self.num_want = 80;
                self.num_want_on_stop = 0;
                ...
                self.encoding_exclusion_pattern = String::from(r"b'[A-Za-z0-9-]'");
                self.peer_url_encode = false;
                self.user_agent = String::from("Transmission/4.0.4");
                self.accept_encoding = String::from("deflate, gzip");
                self.accept = String::from("*/*");
                self.accept_language = String::from("");
            }
            ClientVersion::Transmission_4_0_5 => {
                self.name = String::from("transmission-4.0.5");
                self.key_algorithm =
                    crate::algorithm::Algorithm::DigitRangeTransformedToHexWithoutLeadingZeroes;
                self.key_uppercase = Some(false);
                self.key_refresh_on = crate::RefreshInterval::Never;
                self.peer_algorithm = crate::algorithm::Algorithm::RandomPoolWithChecksum;
                self.peer_pattern = String::from(r"b'0123456789abcdefghijklmnopqrstuvwxyz'");
                self.peer_prefix = String::from("-TR4050-");
                self.peer_refresh_on = crate::RefreshInterval::TorrentVolatile;
                self.uppercase_encoded_hex = false;
                self.num_want = 80;
                self.num_want_on_stop = 0;
                ...
                self.encoding_exclusion_pattern = String::from(r"b'[A-Za-z0-9-]'");
                self.peer_url_encode = false;
                self.user_agent = String::from("Transmission/4.0.5");
                self.accept_encoding = String::from("deflate, gzip");
                self.accept = String::from("*/*");
                self.accept_language = String::from("");
            }
            ClientVersion::Transmission_4_0_6 => {
                self.name = String::from("transmission-4.0.6");
                self.key_algorithm =
                    crate::algorithm::Algorithm::DigitRangeTransformedToHexWithoutLeadingZeroes;
                self.key_uppercase = Some(false);
                self.key_refresh_on = crate::RefreshInterval::Never;
                self.peer_algorithm = crate::algorithm::Algorithm::RandomPoolWithChecksum;
                self.peer_pattern = String::from(r"b'0123456789abcdefghijklmnopqrstuvwxyz'");
                self.peer_prefix = String::from("-TR4060-");
                self.peer_refresh_on = crate::RefreshInterval::TorrentVolatile;
                self.uppercase_encoded_hex = false;
                self.num_want = 80;
                self.num_want_on_stop = 0;
                ...
                self.encoding_exclusion_pattern = String::from(r"b'[A-Za-z0-9-]'");
                self.peer_url_encode = false;
                self.user_agent = String::from("Transmission/4.06");
                self.accept_encoding = String::from("deflate, gzip");
                self.accept = String::from("*/*");
                self.accept_language = String::from("");
            }
            ...
            ClientVersion::Utorrent_3_5_0_43916 => {
                ...
                self.peer_algorithm = crate::algorithm::Algorithm::Regex;
                self.peer_pattern =
                    String::from(r"b'-UT3500-(\xc2\x8c\xc2\xab)[\x01-\xc3\xbf]{10}'");
                self.uppercase_encoded_hex = false;
                self.num_want = 200;
                self.num_want_on_stop = 0;
                self.query = String::from("info_hash={infohash}&peer_id={peerid}&port={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&corrupt=0&key={key}&event={event}&numwant={numwant}&compact=1&no_peer_id=1");
            ...
            ClientVersion::Utorrent_3_5_3_44428 => {
                ...
                self.peer_algorithm = crate::algorithm::Algorithm::Regex;
                self.peer_pattern =
                    String::from(r"b'-UT353S-(\xc2\x8c)(\xc2\xad)[\x01-\xc3\xbf]{10}'");
                self.uppercase_encoded_hex = false;
                self.num_want = 200;
                self.num_want_on_stop = 0;
                self.query = String::from("info_hash={infohash}&peer_id={peerid}&port={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&corrupt=0&key={key}&event={event}&numwant={numwant}&compact=1&no_peer_id=1");
            ...
            ClientVersion::Utorrent_3_5_4_44498 => {
                ...
                self.peer_algorithm = crate::algorithm::Algorithm::Regex;
                self.peer_pattern =
                    String::from(r"b'-UT354S-(\xc3\x92)(\xc2\xad)[\x01-\xc3\xbf]{10}'");
                self.uppercase_encoded_hex = false;
                self.num_want = 200;
                self.num_want_on_stop = 0;
                self.query = String::from("info_hash={infohash}&peer_id={peerid}&port={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&corrupt=0&key={key}&event={event}&numwant={numwant}&compact=1&no_peer_id=1");
