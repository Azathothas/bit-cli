import type { SeedrStatus, TorrentStatusView } from '../config/types.js';
...
function buildTorrentState(mock: MockTorrent, index: number): TorrentStatusView {
  ...
  return {
    ...
    peerId: Buffer.from(`-qB5140-${randomHex(12)}`).toString('hex'),
    key: randomHex(8),
