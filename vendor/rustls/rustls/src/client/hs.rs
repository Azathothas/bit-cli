    ...
    if let Some(ref fingerprint) = config.tls_fingerprint {
        ...
        if ext_config.grease_both_ends {
                ...
                .is_ok()
            {
                ...
                exts.reserved_grease_first = Some(());
                exts.reserved_grease_last = Some(());
